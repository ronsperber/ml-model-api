...
if "dataset" in st.session_state:
    ...
    if missing:
        ...
        cutoff_date = pd.to_datetime(last_data_date)
        fig.add_vline(x=cutoff_date.timestamp() * 1000, line_dash="dot", line_color="red")
        fig.add_annotation(x=cutoff_date.timestamp() * 1000, y=1, yref="paper", text="Training cutoff", showarrow=False)
